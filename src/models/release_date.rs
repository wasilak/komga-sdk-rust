...
pub struct ReleaseDate {
    ...
    pub release_date: Box<models::ReleaseDateAllOfReleaseDate>,
}

impl ReleaseDate {
    pub fn new(release_date: models::ReleaseDateAllOfReleaseDate) -> ReleaseDate {
        ReleaseDate {
            release_date: Box::new(release_date),
        }
    }
}
