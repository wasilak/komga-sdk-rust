...
#[serde(untagged)]
pub enum TitleSortAllOfTitleSort {
    BeginsWith(Box<models::BeginsWith>),
    Contains(Box<models::Contains>),
    DoesNotBeginWith(Box<models::DoesNotBeginWith>),
    DoesNotContain(Box<models::DoesNotContain>),
    DoesNotEndWith(Box<models::DoesNotEndWith>),
    EndsWith(Box<models::EndsWith>),
    Is(Box<models::Is>),
    IsNot(Box<models::IsNot>),
}

impl Default for TitleSortAllOfTitleSort {
    fn default() -> Self {
        Self::BeginsWith(Default::default())
    }
}
