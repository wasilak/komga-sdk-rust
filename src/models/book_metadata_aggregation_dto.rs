...
impl BookMetadataAggregationDto {
    pub fn new(authors: Vec<models::AuthorDto>, created: String, last_modified: String, summary: String, summary_number: String, tags: Vec<String>) -> BookMetadataAggregationDto {
