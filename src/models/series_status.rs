...
pub struct SeriesStatus {
    ...
    pub series_status: Box<models::SeriesStatusAllOfSeriesStatus>,
}

impl SeriesStatus {
    pub fn new(series_status: models::SeriesStatusAllOfSeriesStatus) -> SeriesStatus {
        SeriesStatus {
            series_status: Box::new(series_status),
        }
    }
}
