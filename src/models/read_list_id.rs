...
pub struct ReadListId {
    #[serde(rename = "readListId")]
    pub read_list_id: Box<models::ReadListIdAllOfReadListId>,
}

impl ReadListId {
    pub fn new(read_list_id: models::ReadListIdAllOfReadListId) -> ReadListId {
        ReadListId {
            read_list_id: Box::new(read_list_id),
        }
    }
}
