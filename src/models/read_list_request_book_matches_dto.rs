...
pub struct ReadListRequestBookMatchesDto {
    ...
    pub matches: Vec<models::ReadListRequestBookMatchDto>,
    #[serde(rename = "request")]
    pub request: Box<models::ReadListRequestBookDto>,
}

impl ReadListRequestBookMatchesDto {
    pub fn new(matches: Vec<models::ReadListRequestBookMatchDto>, request: models::ReadListRequestBookDto) -> ReadListRequestBookMatchesDto {
