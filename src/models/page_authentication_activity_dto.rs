...
pub struct PageAuthenticationActivityDto {
    #[serde(rename = "content", skip_serializing_if = "Option::is_none")]
    pub content: Option<Vec<models::AuthenticationActivityDto>>,
...
impl PageAuthenticationActivityDto {
    pub fn new() -> PageAuthenticationActivityDto {
