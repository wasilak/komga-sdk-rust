...
pub struct SharingLabel {
    #[serde(rename = "sharingLabel")]
    pub sharing_label: Box<models::SharingLabelAllOfSharingLabel>,
}

impl SharingLabel {
    pub fn new(sharing_label: models::SharingLabelAllOfSharingLabel) -> SharingLabel {
        SharingLabel {
            sharing_label: Box::new(sharing_label),
        }
    }
}
