...
pub struct MediaStatus {
    ...
    pub media_status: Box<models::MediaStatusAllOfMediaStatus>,
}

impl MediaStatus {
    pub fn new(media_status: models::MediaStatusAllOfMediaStatus) -> MediaStatus {
        MediaStatus {
            media_status: Box::new(media_status),
        }
    }
}
