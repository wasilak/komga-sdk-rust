...
pub struct NumberSort {
    #[serde(rename = "numberSort")]
    pub number_sort: Box<models::NumberSortAllOfNumberSort>,
}

impl NumberSort {
    pub fn new(number_sort: models::NumberSortAllOfNumberSort) -> NumberSort {
        NumberSort {
            number_sort: Box::new(number_sort),
        }
    }
}
