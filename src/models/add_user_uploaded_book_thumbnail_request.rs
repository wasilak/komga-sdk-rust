...
pub struct AddUserUploadedBookThumbnailRequest {
    #[serde(rename = "file")]
    pub file: std::path::PathBuf,
}

impl AddUserUploadedBookThumbnailRequest {
    pub fn new(file: std::path::PathBuf) -> AddUserUploadedBookThumbnailRequest {
