...
impl ThumbnailBookDto {
    pub fn new(book_id: String, file_size: i64, height: i32, id: String, media_type: String, selected: bool, r#type: String, width: i32) -> ThumbnailBookDto {
        ThumbnailBookDto {
            book_id,
            file_size,
            height,
