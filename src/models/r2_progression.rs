...
pub struct R2Progression {
    #[serde(rename = "device")]
    pub device: Box<models::R2Device>,
    #[serde(rename = "locator")]
    pub locator: Box<models::R2Locator>,
    #[serde(rename = "modified")]
    pub modified: String,
}

impl R2Progression {
    pub fn new(device: models::R2Device, locator: models::R2Locator, modified: String) -> R2Progression {
        R2Progression {
