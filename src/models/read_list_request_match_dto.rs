...
pub struct ReadListRequestMatchDto {
    ...
    pub read_list_match: Box<models::ReadListMatchDto>,
    #[serde(rename = "requests")]
    pub requests: Vec<models::ReadListRequestBookMatchesDto>,
}

impl ReadListRequestMatchDto {
    pub fn new(error_code: String, read_list_match: models::ReadListMatchDto, requests: Vec<models::ReadListRequestBookMatchesDto>) -> ReadListRequestMatchDto {
