...
pub struct WpBelongsToDto {
    ...
    pub collection: Vec<models::WpContributorDto>,
    #[serde(rename = "series")]
    pub series: Vec<models::WpContributorDto>,
}

impl WpBelongsToDto {
    pub fn new(collection: Vec<models::WpContributorDto>, series: Vec<models::WpContributorDto>) -> WpBelongsToDto {
        WpBelongsToDto {
            collection,
            series,
        }
