...
pub struct ReadListRequestBookMatchDto {
    #[serde(rename = "books")]
    pub books: Vec<models::ReadListRequestBookMatchBookDto>,
    #[serde(rename = "series")]
    pub series: Box<models::ReadListRequestBookMatchSeriesDto>,
}

impl ReadListRequestBookMatchDto {
    pub fn new(books: Vec<models::ReadListRequestBookMatchBookDto>, series: models::ReadListRequestBookMatchSeriesDto) -> ReadListRequestBookMatchDto {
