...
impl TachiyomiReadProgressDto {
    pub fn new(books_count: i32, books_in_progress_count: i32, books_read_count: i32, books_unread_count: i32, last_read_continuous_index: i32) -> TachiyomiReadProgressDto {
