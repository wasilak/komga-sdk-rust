...
impl ThumbnailSeriesCollectionDto {
    pub fn new(collection_id: String, file_size: i64, height: i32, id: String, media_type: String, selected: bool, r#type: String, width: i32) -> ThumbnailSeriesCollectionDto {
