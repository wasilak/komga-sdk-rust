...
#[serde(untagged)]
pub enum AgeRatingAllOfAgeRating {
    GreaterThan(Box<models::GreaterThan>),
    Is(Box<models::Is>),
    IsNot(Box<models::IsNot>),
    IsNotNullT(Box<models::IsNotNullT>),
    IsNullT(Box<models::IsNullT>),
    LessThan(Box<models::LessThan>),
}

impl Default for AgeRatingAllOfAgeRating {
    fn default() -> Self {
        Self::GreaterThan(Default::default())
    }
}
