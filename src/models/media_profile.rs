...
pub struct MediaProfile {
    ...
    pub media_profile: Box<models::MediaProfileAllOfMediaProfile>,
}

impl MediaProfile {
    pub fn new(media_profile: models::MediaProfileAllOfMediaProfile) -> MediaProfile {
        MediaProfile {
            media_profile: Box::new(media_profile),
        }
    }
}
