...
/// struct for typed errors of method [`get_book_sibling_next_in_read_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetBookSiblingNextInReadListError {
    Status400(models::ValidationErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_book_sibling_previous_in_read_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetBookSiblingPreviousInReadListError {
    Status400(models::ValidationErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_books_by_read_list_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetBooksByReadListIdError {
    Status400(models::ValidationErrorResponse),
    UnknownValue(serde_json::Value),
}


pub async fn get_book_sibling_next_in_read_list(configuration: &configuration::Configuration, id: &str, book_id: &str) -> Result<models::BookDto, Error<GetBookSiblingNextInReadListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_path_book_id = book_id;

    let uri_str = format!("{}/api/v1/readlists/{id}/books/{bookId}/next", configuration.base_path, id=crate::apis::urlencode(p_path_id), bookId=crate::apis::urlencode(p_path_book_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetBookSiblingNextInReadListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_book_sibling_previous_in_read_list(configuration: &configuration::Configuration, id: &str, book_id: &str) -> Result<models::BookDto, Error<GetBookSiblingPreviousInReadListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_path_book_id = book_id;

    let uri_str = format!("{}/api/v1/readlists/{id}/books/{bookId}/previous", configuration.base_path, id=crate::apis::urlencode(p_path_id), bookId=crate::apis::urlencode(p_path_book_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetBookSiblingPreviousInReadListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_books_by_read_list_id(configuration: &configuration::Configuration, id: &str, library_id: Option<Vec<String>>, read_status: Option<Vec<String>>, tag: Option<Vec<String>>, media_status: Option<Vec<String>>, deleted: Option<bool>, unpaged: Option<bool>, page: Option<i32>, size: Option<i32>, author: Option<Vec<String>>) -> Result<models::PageBookDto, Error<GetBooksByReadListIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    let uri_str = format!("{}/api/v1/readlists/{id}/books", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetBooksByReadListIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
