...
/// struct for typed errors of method [`mark_read_list_thumbnail_selected`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MarkReadListThumbnailSelectedError {
    Status400(models::ValidationErrorResponse),
    UnknownValue(serde_json::Value),
}

/// Required role: **ADMIN**
pub async fn add_user_uploaded_read_list_thumbnail(
    configuration: &configuration::Configuration,
    id: &str,
    file: std::path::PathBuf,
    selected: Option<bool>,
) -> Result<models::ThumbnailReadListDto, Error<AddUserUploadedReadListThumbnailError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ThumbnailReadListDto`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ThumbnailReadListDto`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AddUserUploadedReadListThumbnailError> =
...
/// Required role: **ADMIN**
pub async fn delete_user_uploaded_read_list_thumbnail(
    configuration: &configuration::Configuration,
    id: &str,
    thumbnail_id: &str,
) -> Result<(), Error<DeleteUserUploadedReadListThumbnailError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteUserUploadedReadListThumbnailError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_read_list_thumbnail(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<std::path::PathBuf, Error<GetReadListThumbnailError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetReadListThumbnailError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_read_list_thumbnail_by_id(
    configuration: &configuration::Configuration,
    id: &str,
    thumbnail_id: &str,
) -> Result<std::path::PathBuf, Error<GetReadListThumbnailByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_path_thumbnail_id = thumbnail_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetReadListThumbnailByIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_read_list_thumbnails(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<Vec<models::ThumbnailReadListDto>, Error<GetReadListThumbnailsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::ThumbnailReadListDto&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::ThumbnailReadListDto&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetReadListThumbnailsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
/// Required role: **ADMIN**
pub async fn mark_read_list_thumbnail_selected(
    configuration: &configuration::Configuration,
    id: &str,
    thumbnail_id: &str,
) -> Result<(), Error<MarkReadListThumbnailSelectedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_path_thumbnail_id = thumbnail_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MarkReadListThumbnailSelectedError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
